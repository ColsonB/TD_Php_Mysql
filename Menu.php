...
function Menu(){
    ...
    <div class="nav">
        <ul class="nav-menu">
            <li><a href="#" class="nav-active"></a>
            <li><a href="#" class="nav-active">Exercice HTML</a>
            <ul>
                <li><a href='HTML_PremierExercice.php'>Premiére Exercice</a></li>
                <li><a href='HTML_Exo1.php'>Exercice 1</a></li>
                <li><a href='HTML_Exo2.php'>Exercice 2</a></li>
                <li><a href='HTML_Exo3.php'>Exercice 3</a></li>
                <li><a href='HTML_Exo1_CSS.php'>Exercice 1 CSS</a></li>
                <li><a href='HTML_Exo2_CSS.php'>Exercice 2 CSS</a></li>
                <li><a href='HTML_Exo3_CSS.php'>Exercice 3 CSS</a></li>
                <li><a href='HTML_Exo4_CSS.php'>Exercice 4 CSS</a></li>
                <li><a href='HTML_Tableau.php'>Tableau</a></li>
            </ul>
            <li><a href="#" class="nav-active">Exercice PHP Partie 1</a>
            <ul>
                <li><a href='PHP_Partie1_Exo1.php'>Exercice 1</a></li>
                <li><a href='PHP_Partie1_Exo2.1.php'>Exercice 2.1</a></li>
                <li><a href='PHP_Partie1_Exo2.2.php'>Exercice 2.2</a></li>
